...
HD_PWD='/home/leonrinkel/microlinux/microlinux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microlinux_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microlinux_1_wrapper.tcl
