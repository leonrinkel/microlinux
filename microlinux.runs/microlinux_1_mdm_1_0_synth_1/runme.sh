...
HD_PWD='/home/leonrinkel/microlinux/microlinux.runs/microlinux_1_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microlinux_1_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microlinux_1_mdm_1_0.tcl
