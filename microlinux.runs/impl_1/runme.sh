...
HD_PWD='/home/leonrinkel/microlinux/microlinux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microlinux_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microlinux_1_wrapper.tcl -notrace
